...
from gen_dft_data import gen_ete_deblur_data
...
MODEL_NAME = "blur_"+str(prefixed)+"_"+str(butterfly)+"_model"
for it in range(max_iter):
    xdata,ydata,udata,xnorm,ynorm,unorm,brel = gen_ete_deblur_data(
                                            freqmag,freqidx,batch_siz,sig,blur_sig)
