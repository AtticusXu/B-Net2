...
solvetrain_loss_train = MSE_loss_train_f
...
solvetrain_loss_test = MSE_loss_test_f

train_step = optimizer_adam.minimize(MSE_loss_train_u,global_step=global_steps)
# in solve-train, solvetrain_loss_test is used intead of MSE_loss_train_u
...
MODEL_NAME = "equations_"+str(linear) +"_"+str(prefixed)+"_"+str(butterfly)+"_model"
